...
# 📖 [Hello-React-Rails] <a name="about-project"></a>
  ...
  **[Hello-React-Rails]** is app build using ruby on rails and react
...
```sh
  cd my-folder
  https://github.com/atok624/Hello-React-Rails.git
```
...
Feel free to check the [issues page](https://github.com/atok624/Hello-React-Rails/issues).
